      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return fetchService.performPostHttpRequest("https://baku.colabo.com/api/v1/search_box?limit=5&field=name&field=score&field=model&field=image_urls", headers, jsonFormData);
          ...
          case 8:
            ...
            if (response) {
              console.log("WORKED"); //window.location = `/success.html?FirstName=${response.FirstName}&LastName=${response.LastName}&Email=${response.Email}&id=${response.id}`;
...
/*--/Event Listeners--*/
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","./service/FetchService":"js/service/FetchService.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
